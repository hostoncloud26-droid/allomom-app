  ...
  Future<void> _onCodeChanged() async {
    ...
    if (code.length == 6 && !_isLoading && _motherData == null) {
      ...
      try {
        ...
        final mother = members
            .cast<FamilyMemberWithUser?>()
            .firstWhere(
              (m) =>
    ...
    } else if (code.length < 6 && (_motherData != null || _errorMessage != null)) {
      setState(() {
        _familyData = null;
        _motherData = null;
        _errorMessage = null;
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // ─── BABY SPEECH AVATAR ───
            BabySpeechAvatar(
              speechText: 'Ask Mommy for her 6-digit\nFamily Code to join! 💌',
              onSpeakerTap: () {
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: _errorMessage != null
                            ? Colors.redAccent
                            : (_motherData != null ? const Color(0xFF10B981) : const Color(0xFFE5E7EB)),
                        width: 1.5,
                      ),
                    ),
                    child: Row(
                      children: [
                        Icon(
                          Icons.tag_rounded,
                          color: _motherData != null ? const Color(0xFF10B981) : primaryColor,
                          size: 22,
                        ),
                      ...
                      Expanded(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: _motherData != null ? _proceedToFinish : null,
