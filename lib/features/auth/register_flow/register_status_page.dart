      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // ─── BABY SPEECH AVATAR ───
            BabySpeechAvatar(
              speechText: 'Tell me where we are on this magical journey! ✨',
              onSpeakerTap: () {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) => KidsDetailsPage(
                                ...
                                eddDate: DateTime.now(),
                                lmpDate: DateTime.now().subtract(const Duration(days: 280)),
                                phone: widget.phone,
