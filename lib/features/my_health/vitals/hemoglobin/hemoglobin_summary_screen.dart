// Hemoglobin summary, built in the shape of AlloConnect's
...
import 'views/daily_hemoglobin_view.dart';
import 'views/monthly_hemoglobin_view.dart';
import 'views/weekly_hemoglobin_view.dart';

class HemoglobinSummaryScreen extends StatefulWidget {
  ...
  @override
  State<HemoglobinSummaryScreen> createState() =>
      _HemoglobinSummaryScreenState();
}
...
class _HemoglobinSummaryScreenState extends State<HemoglobinSummaryScreen> {
  ...
  Future<void> _openAddSheet() async {
    final saved = await showHemoglobinEntrySheet(
      context,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        backgroundColor: kHemoglobinColor,
  ...
  Widget _buildCurrentView() {
    switch (_selectedFilterIndex) {
      ...
      case 1:
        return WeeklyHemoglobinView(
          key: ValueKey('weekly-$_refreshTick'),
          onChanged: _refresh,
        );
      case 2:
        return MonthlyHemoglobinView(
