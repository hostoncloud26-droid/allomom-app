...
class HrvWeeklyView extends StatefulWidget {
  final String userId;
  const HrvWeeklyView({super.key, required this.userId});

  @override
  State<HrvWeeklyView> createState() => _HrvWeeklyViewState();
}

class _HrvWeeklyViewState extends State<HrvWeeklyView> {
              ...
              getTooltipItem: (group, groupIndex, rod, rodIndex) {
                ...
                return BarTooltipItem(
                  ...
                  children: [
                    TextSpan(
                      text:
                          'Range: ${stat.min.toInt()} - ${stat.max.toInt()} ms\n',
                      style: TextStyle(
