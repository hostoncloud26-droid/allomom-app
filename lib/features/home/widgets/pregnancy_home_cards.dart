...
class AlloBabyFlowCard extends StatelessWidget {
  ...
  /// Opens Ask Allo, for when she wants to keep talking.
        ...
        return _SectionCard(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: AnimatedSwitcher(
                    ...
                    child: Text(
                      line.isEmpty
                          ? (running ? '…' : 'Tap below to hear from me.')
                          : line,
                      key: ValueKey(line),
                      style: TextStyle(
                        fontSize: 15,
              ...
              if (!running && controller.options.isNotEmpty) ...[
                const SizedBox(height: 8),
                SizedBox(
                  height: 36,
              ...
              // Nothing to press while she talks: the docked mic stops her.
              if (!running) const SizedBox(height: 10),
              if (running)
                const SizedBox.shrink()
              else if (controller.hasRun && onOpenChat != null)
                _CardButton(
                  icon: Icons.chat_bubble_rounded,
                  label: 'Talk to AlloBaby',
                  onTap: onOpenChat,
                )
              else
                _CardButton(
                  icon: Icons.play_arrow_rounded,
                  label: 'Hear from AlloBaby',
