...
const List<ScheduledReport> reportSchedule = [
  ...
  ScheduledReport(
    name: '2nd Month Urine Routine Examination',
    month: 2,
  ...
  ScheduledReport(
    name: '3rd Month Urine Routine Examination',
    month: 3,
    purpose: 'Detect protein, sugar, and urinary infection',
    isRequired: true,
    category: 'urine',
  ...
  ScheduledReport(
    name: '4th Month Urine Routine Examination',
    month: 4,
    purpose: 'Detect protein, sugar, and urinary infection',
    isRequired: true,
    category: 'urine',
  ...
  ScheduledReport(
    name: '5th Month Urine Routine Examination',
    month: 5,
    purpose: 'Detect protein, sugar, and urinary infection',
    isRequired: true,
    category: 'urine',
  ...
  ScheduledReport(
    name: '6th Month Urine Routine Examination',
    month: 6,
    purpose: 'Detect protein, sugar, and urinary infection',
    isRequired: true,
    category: 'urine',
  ...
  ScheduledReport(
    name: '7th Month Urine Routine Examination',
    month: 7,
    purpose: 'Detect protein, sugar, and urinary infection',
    isRequired: true,
    category: 'urine',
